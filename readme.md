...
![WordPress Plugin](https://img.shields.io/badge/WordPress-6.8%2B-blue)
...
⚠️ You are not required to take immediate action. Your website will continue working normally during the transition period. A detailed migration panel is included inside the plugin settings with all guidance and support information.
...
> ⚠️ **Translate Words is evolving to Linguator**, our new AI-based multilingual solution.  
...
## 🌟 Made with ❤️ by Cool Plugins

### [⭐ Rate Us](https://wordpress.org/support/plugin/translate-words/reviews/) | [🐛 Report Issues](https://github.com/CoolPluginsTeam/translate-words/issues) | [📖 Documentation](https://linguator.com/)
