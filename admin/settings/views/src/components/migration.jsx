    ...
    const performMigration = async () => {
        ...
        try {
            ...
            if (response.success) {
                ...
                toast.error(response.message || __('Migration failed.', 'translate-words'))
            }
        } catch (error) {
            ...
            <Container className='bg-white p-10 rounded-lg shadow-sm' cols="1" containerType='grid'>
                <Container.Item>
                    <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <h2 className="text-2xl font-bold mb-2">{__('Migration Already Completed', 'translate-words')}</h2>
                        <p className="text-gray-600 text-center max-w-md">
                            {__('You have already completed the migration to Linguator. All your data has been successfully migrated.', 'translate-words')}
                        </p>
                    </div>
                </Container.Item>
            </Container>
